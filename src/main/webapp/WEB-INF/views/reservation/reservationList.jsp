...
<script>
  ...
  function initData() {
    goAjaxPost('/reservationList', {adminNo: adminNo, reservationDate: reservationDate},
        function (result) {
          $('#reserTb').html('');
          var html = '<tr>' +
          ...
          $(result.data).each(function (k, v) {
            html += '<tr>' +
                ...
                '<td><button type="button" class="confirm" style="width:100%;" value="'
                + v.reservationNo + '">' + v.isConfirm + '</button></td>' +
                '</tr>';
          });
          $('#reserTb').html(html);
    ...
    <div class="container">
        <div class="text-center">
            ...
            <p>Date: <input type="text" id="datepicker">
                <button type="button" class="btn-primary" id="search">검색</button>
            </p>
        </div>
        <div class="row">
